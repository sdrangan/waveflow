...
from waveflow.vitis_l1.fft import GROW_TO_MAX_WIDTH, NO_SCALING, SCALE, fft16
from waveflow.utils import fixputils as fp

GOLDEN = Path(__file__).resolve().parent / "golden" / "fft_L16_R4_modes.json"
...
def test_scale_actually_shifts(g):
    ...
    """
    import waveflow.vitis_l1.fft as mod
