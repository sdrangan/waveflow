...
This is the **working record** of how the model was built: what was measured, what was wrong,
and what remains.  For the plan that carries this forward into Waveflow `HwModule`s, see
[`plans/vitis_l1_hwmodule.md`](../../../plans/vitis_l1_hwmodule.md).
