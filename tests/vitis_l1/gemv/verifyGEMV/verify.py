...
from waveflow.vitis_l1.fixed import (
    OMode,
    QMode,
    fixed_format,
    gemv_fixed_as_shipped,
)
from waveflow.vitis_l1.gemv import f32_bits, gemv, gemv_ab, gemv_int
...
def fma_verdict() -> bool:
    ...
    if hit_f == n and hit_u < n:
        print(f"  {RED}=> Vitis HLS DOES fuse it.{RESET}  waveflow.vitis_l1.gemv.axpy models the wrong "
