...
A [`HwComponent`](./overview.md) is a *template* for hardware, not a single fixed block. Parameterizing
...
- [Defining a component](./overview.md) — where these fields are declared on the class.
