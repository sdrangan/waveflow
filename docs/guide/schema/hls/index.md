...
each schema becomes — and [serialization](./serialization.md) — moving a **single** schema value in and
out over a packed integer, an `m_axi` memory port, a FIFO, or an AXI4-Stream.
