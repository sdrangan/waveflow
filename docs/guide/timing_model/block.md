...
Here it is on a [stream-of-blocks](../interface/primitive/sob.md) `Compute` sub-component — the canonical
...
- [Stream of Blocks](../interface/primitive/sob.md) — the `acquire_read` / block channel used here, and
