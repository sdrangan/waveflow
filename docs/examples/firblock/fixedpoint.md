...
[sweep](./resources.md) runs `W ∈ {8, 12, 16, 24}` and would hit the ceiling at `W = 32` with 32 taps,
...
- [Resource modelling](./resources.md) — what changing `W` actually costs in DSPs, measured: a *fall*
