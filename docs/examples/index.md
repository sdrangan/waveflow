...
The accelerator's *internal* load-compute-store structure and its timing model are covered in the
[timing-model](../guide/timing_model/) and [timing model fitting](../guide/calib/) guides; `mmqueue`
