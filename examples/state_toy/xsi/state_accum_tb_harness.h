#ifndef WAVEFLOW_GEN_STATE_ACCUM_TB_HARNESS_H
#define WAVEFLOW_GEN_STATE_ACCUM_TB_HARNESS_H
// state_accum_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
...
#include <vector>
#include "xsi_bfm.h"
#include "state_accum_ports.h"

namespace state_accum_tb {
...
struct Harness {
    ...
    explicit Harness(const std::string& wdb)
      : sim(state_accum_ports::DESIGN_DLL, wdb),
        s_in(sim.dut(), state_accum_ports::s_in, {}),
        m_out(sim.dut(), state_accum_ports::m_out)
    {
        ...
        sim.pin_low(state_accum_ports::ZERO_PORTS, state_accum_ports::ZERO_PORTS_N);
        ...
        m_out.out_bundle = "vectors/m_out";
    }
...
#endif  // WAVEFLOW_GEN_STATE_ACCUM_TB_HARNESS_H
