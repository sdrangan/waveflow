#ifndef INCLUDE_BRAM_WRITE_CMD_TB_H
#define INCLUDE_BRAM_WRITE_CMD_TB_H
...
#define WAVEFLOW_ENABLE_BRAM_WRITE_CMD_TB_H_MEMBERS
#include "bram_write_cmd.h"
#undef WAVEFLOW_ENABLE_BRAM_WRITE_CMD_TB_H_MEMBERS

inline void WriteCmd::dump_json(std::ostream& os, int indent, int level) const {
...
inline void WriteCmd::load_json(const std::string& json_text, size_t& pos) {
...
inline void WriteCmd::load_json(std::istream& is) {
...
inline void WriteCmd::dump_json_file(const char* file_path, int indent) const {
...
inline void WriteCmd::load_json_file(const char* file_path) {
...
#endif // INCLUDE_BRAM_WRITE_CMD_TB_H