#ifndef INCLUDE_BRAM_WRITE_RESP_TB_H
#define INCLUDE_BRAM_WRITE_RESP_TB_H
...
#define WAVEFLOW_ENABLE_BRAM_WRITE_RESP_TB_H_MEMBERS
#include "bram_write_resp.h"
#undef WAVEFLOW_ENABLE_BRAM_WRITE_RESP_TB_H_MEMBERS

inline void WriteResp::dump_json(std::ostream& os, int indent, int level) const {
...
inline void WriteResp::load_json(const std::string& json_text, size_t& pos) {
...
inline void WriteResp::load_json(std::istream& is) {
...
inline void WriteResp::dump_json_file(const char* file_path, int indent) const {
...
inline void WriteResp::load_json_file(const char* file_path) {
...
#endif // INCLUDE_BRAM_WRITE_RESP_TB_H