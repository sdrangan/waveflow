#ifndef INCLUDE_BRAM_READ_RESP_H
#define INCLUDE_BRAM_READ_RESP_H
...
struct ReadResp {
    ...
    static ap_uint<bitwidth> pack_to_uint(const ReadResp& data) {
    ...
    static ReadResp unpack_from_uint(const ap_uint<bitwidth>& packed) {
        ReadResp data;
    ...
    template<int word_bw>
    static void write_array_impl(word_bw_tag<word_bw>, const ReadResp* self, ap_uint<word_bw> x[]) {
        static_assert(word_bw < 0, "Unsupported word_bw for write_array");
        (void)self;
        (void)x;
    }

    static void write_array_impl(word_bw_tag<64>, const ReadResp* self, ap_uint<64> x[]) {
        x[0] = self->tid;
    ...
    template<int word_bw>
    static void write_stream_impl(word_bw_tag<word_bw>, const ReadResp* self, hls::stream<ap_uint<word_bw>> &s) {
        static_assert(word_bw < 0, "Unsupported word_bw for write_stream");
        (void)self;
        (void)s;
    }

    static void write_stream_impl(word_bw_tag<64>, const ReadResp* self, hls::stream<ap_uint<64>> &s) {
            ap_uint<64> w = 0;
        w = self->tid;
        s.write(w);
        w = 0;
    ...
    template<int word_bw>
    static void write_axi4_stream_impl(word_bw_tag<word_bw>, const ReadResp* self, hls::stream<streamutils::axi4s_word<word_bw>> &s, bool tlast) {
    ...
    static void write_axi4_stream_impl(word_bw_tag<64>, const ReadResp* self, hls::stream<streamutils::axi4s_word<64>> &s, bool tlast) {
            ap_uint<64> w = 0;
        w = self->tid;
    ...
    template<int word_bw>
    static void read_array_impl(word_bw_tag<word_bw>, ReadResp* self, const ap_uint<word_bw> x[]) {
        static_assert(word_bw < 0, "Unsupported word_bw for read_array");
        (void)self;
        (void)x;
    }

    static void read_array_impl(word_bw_tag<64>, ReadResp* self, const ap_uint<64> x[]) {
    ...
    template<int word_bw>
    static void read_stream_impl(word_bw_tag<word_bw>, ReadResp* self, hls::stream<ap_uint<word_bw>> &s) {
        static_assert(word_bw < 0, "Unsupported word_bw for read_stream");
        (void)self;
        (void)s;
    }

    static void read_stream_impl(word_bw_tag<64>, ReadResp* self, hls::stream<ap_uint<64>> &s) {
            ap_uint<64> w = 0;
        w = s.read();
    ...
    template<int word_bw>
    static void read_axi4_stream_impl(word_bw_tag<word_bw>, ReadResp* self, hls::stream<streamutils::axi4s_word<word_bw>> &s, streamutils::tlast_status &tl) {
    ...
    static void read_axi4_stream_impl(word_bw_tag<64>, ReadResp* self, hls::stream<streamutils::axi4s_word<64>> &s, streamutils::tlast_status &tl) {
            ap_uint<64> w = 0;
...
#ifdef WAVEFLOW_ENABLE_BRAM_READ_RESP_TB_H_MEMBERS
...
#endif // INCLUDE_BRAM_READ_RESP_H