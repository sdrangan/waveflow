#ifndef WAVEFLOW_GEN_BRAM_SIMPLE_TB_HARNESS_H
#define WAVEFLOW_GEN_BRAM_SIMPLE_TB_HARNESS_H
// bram_simple_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
...
#include <vector>
#include "xsi_bfm.h"
#include "bram_simple_ports.h"

namespace bram_simple_tb {
...
struct Harness {
    ...
    explicit Harness(const std::string& wdb)
      : sim(bram_simple_ports::DESIGN_DLL, wdb),
        cmd_w(sim.dut(), bram_simple_ports::cmd_w, {}),
        data_w(sim.dut(), bram_simple_ports::data_w, {}),
        resp_w(sim.dut(), bram_simple_ports::resp_w),
        cmd_r(sim.dut(), bram_simple_ports::cmd_r, {}),
        data_r(sim.dut(), bram_simple_ports::data_r),
        resp_r(sim.dut(), bram_simple_ports::resp_r)
    {
        ...
        sim.pin_low(bram_simple_ports::ZERO_PORTS, bram_simple_ports::ZERO_PORTS_N);
...
#endif  // WAVEFLOW_GEN_BRAM_SIMPLE_TB_HARNESS_H
