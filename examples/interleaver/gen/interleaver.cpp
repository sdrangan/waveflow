// interleaver.cpp — GENERATED (examples/interleaver/mem_stream_gen.py).
...
#pragma HLS INTERFACE ap_ctrl_none port=return
    ...
    hls_thread_local hls::stream<ap_uint<64> > p_words;
    #pragma HLS STREAM variable=p_words depth=1024
    hls_thread_local hls::stream<ap_uint<64> > x_words;
    ...
    hls_thread_local hls::task t2(demux_task<64, 128>, mem_out, p_words, x_words);
    hls_thread_local hls::task t3(fill_task<64, 128>, x_words, x_blk);
    hls_thread_local hls::task t4(gather_word_task<64, 128>, p_words, x_blk, y_words);
    hls_thread_local hls::task t5(mem_w_stream_done_task<64>, mw_cmd, y_words, m_out, s_done);
}
