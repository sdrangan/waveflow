#ifndef WAVEFLOW_GEN_RF_SHOT_TX_PORTS_H
#define WAVEFLOW_GEN_RF_SHOT_TX_PORTS_H
// rf_shot_tx_ports.h -- GENERATED by waveflow (build/composite_gen.py::render_ports_h) from the SAME
// TopSpec that emits rf_shot_tx's interface pragmas.  DO NOT EDIT: regenerate instead.
// One spec, two consumers -- so a testbench cannot drift from the kernel it drives.

namespace rf_shot_tx_ports {

static const char* const TOP        = "rf_shot_tx_top";
...
#ifdef _WIN32
static const char* const DESIGN_DLL = "xsim.dir/rf_shot_tx_top/xsimk.dll";
#else
static const char* const DESIGN_DLL = "xsim.dir/rf_shot_tx_top/xsimk.so";
#endif
...
#endif  // WAVEFLOW_GEN_RF_SHOT_TX_PORTS_H
