#ifndef WAVEFLOW_GEN_RF_PASS_THROUGH_PORTS_H
#define WAVEFLOW_GEN_RF_PASS_THROUGH_PORTS_H
// rf_pass_through_ports.h -- GENERATED by waveflow (build/composite_gen.py::render_ports_h) from the SAME
// TopSpec that emits rf_pass_through's interface pragmas.  DO NOT EDIT: regenerate instead.
// One spec, two consumers -- so a testbench cannot drift from the kernel it drives.

namespace rf_pass_through_ports {

static const char* const TOP        = "rf_pass_through";
...
#ifdef _WIN32
static const char* const DESIGN_DLL = "xsim.dir/rf_pass_through/xsimk.dll";
#else
static const char* const DESIGN_DLL = "xsim.dir/rf_pass_through/xsimk.so";
#endif
...
#endif  // WAVEFLOW_GEN_RF_PASS_THROUGH_PORTS_H
