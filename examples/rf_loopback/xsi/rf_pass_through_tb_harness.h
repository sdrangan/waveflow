#ifndef WAVEFLOW_GEN_RF_PASS_THROUGH_TB_HARNESS_H
#define WAVEFLOW_GEN_RF_PASS_THROUGH_TB_HARNESS_H
// rf_pass_through_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
...
struct Harness {
    ...
    explicit Harness(const std::string& wdb)
      : sim(rf_pass_through_ports::DESIGN_DLL, wdb),
        s_in(sim.dut(), rf_pass_through_ports::s_in, {}),
        s_out(sim.dut(), rf_pass_through_ports::s_out)
    {
        ...
        s_in.in_bundle = "vectors/s_in";
        s_out.out_bundle = "vectors/s_out";
    }
...
#endif  // WAVEFLOW_GEN_RF_PASS_THROUGH_TB_HARNESS_H
