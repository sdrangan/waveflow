#ifndef WAVEFLOW_GEN_RF_LOOPBACK_2CH_TB_HARNESS_H
#define WAVEFLOW_GEN_RF_LOOPBACK_2CH_TB_HARNESS_H
// rf_loopback_2ch_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
...
#include "rf_pass_through_2ch_ports.h"

namespace rf_loopback_2ch_tb {
...
struct Harness {
    ...
    BlockChannel<RfBlockMsg> xsi_tb_2ch_adc_if;
    BlockChannel<RfBlockMsg> xsi_tb_2ch_dac_if;
    RfdcAdcMaster s_in_0;
    RfdcDacSlave s_out_0;
    RfFileSource xsi_tb_2ch_adc_if_tx;
    RfFileSink xsi_tb_2ch_dac_if_rx;
    ...
    explicit Harness(const std::string& wdb)
      : sim(rf_pass_through_2ch_ports::DESIGN_DLL, wdb),
        ...
        xsi_tb_2ch_adc_if_tx(xsi_tb_2ch_adc_if, 512, 0),
        xsi_tb_2ch_dac_if_rx(xsi_tb_2ch_dac_if, 0)
    {
        ...
        sim.pin_low(rf_pass_through_2ch_ports::ZERO_PORTS, rf_pass_through_2ch_ports::ZERO_PORTS_N);
        ...
        participants_.push_back(&xsi_tb_2ch_adc_if);
        participants_.push_back(&xsi_tb_2ch_dac_if);
        participants_.push_back(&s_in_0);
        participants_.push_back(&s_out_0);
        participants_.push_back(&xsi_tb_2ch_adc_if_tx);
        participants_.push_back(&xsi_tb_2ch_dac_if_rx);
        ...
        xsi_tb_2ch_adc_if_tx.in_bundle = "vectors/rf_in_2ch";
        xsi_tb_2ch_dac_if_rx.out_bundle = "vectors/rf_out_2ch";
    }
...
#endif  // WAVEFLOW_GEN_RF_LOOPBACK_2CH_TB_HARNESS_H
