#ifndef WAVEFLOW_GEN_RF_SHOT_TX_ABS_TB_HARNESS_H
#define WAVEFLOW_GEN_RF_SHOT_TX_ABS_TB_HARNESS_H
// rf_shot_tx_abs_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
// from the rf_shot_tx_abs testbench graph.  DO NOT EDIT: regenerate instead.
//
...
#include "rf_shot_tx_abs_ports.h"

namespace rf_shot_tx_abs_tb {
...
struct Harness {
    ...
    explicit Harness(const std::string& wdb)
      : sim(rf_shot_tx_abs_ports::DESIGN_DLL, wdb),
        xsi_tb_dac_if(2),
        s_in(sim.dut(), rf_shot_tx_abs_ports::s_in, {}),
        resp_out(sim.dut(), rf_shot_tx_abs_ports::resp_out),
        samp_out(sim.dut(), rf_shot_tx_abs_ports::samp_out, xsi_tb_dac_if, RfdcFormat{14, 4, 1.0, 16, 2, RFDC_REAL, RFDC_I_LOW}, 0.256, 64),
        xsi_tb_dac_if_rx(xsi_tb_dac_if, 0)
    {
        ...
        sim.pin_low(rf_shot_tx_abs_ports::ZERO_PORTS, rf_shot_tx_abs_ports::ZERO_PORTS_N);
...
#endif  // WAVEFLOW_GEN_RF_SHOT_TX_ABS_TB_HARNESS_H
