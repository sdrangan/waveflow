#ifndef INCLUDE_BRAM_READ_CMD_H
#define INCLUDE_BRAM_READ_CMD_H
...
struct ReadCmd {
    ...
    ap_uint<64> nsamp;  // words to return
    ap_uint<64> raddr;  // first word address read
    ...
    static ap_uint<bitwidth> pack_to_uint(const ReadCmd& data) {
        ap_uint<bitwidth> res = 0;
        res.range(63, 0) = data.tid;
        res.range(127, 64) = data.nsamp;
        res.range(191, 128) = data.raddr;
        return res;
    }

    static ReadCmd unpack_from_uint(const ap_uint<bitwidth>& packed) {
        ReadCmd data;
        data.tid = (ap_uint<64>)(packed.range(63, 0));
        data.nsamp = (ap_uint<64>)(packed.range(127, 64));
        data.raddr = (ap_uint<64>)(packed.range(191, 128));
        return data;
    }

    template<int word_bw>
    static void write_array_impl(word_bw_tag<word_bw>, const ReadCmd* self, ap_uint<word_bw> x[]) {
        static_assert(word_bw < 0, "Unsupported word_bw for write_array");
        (void)self;
        (void)x;
    }

    static void write_array_impl(word_bw_tag<64>, const ReadCmd* self, ap_uint<64> x[]) {
        x[0] = self->tid;
        x[1] = self->nsamp;
        x[2] = self->raddr;
    }
    ...
    template<int word_bw>
    static void write_stream_impl(word_bw_tag<word_bw>, const ReadCmd* self, hls::stream<ap_uint<word_bw>> &s) {
        static_assert(word_bw < 0, "Unsupported word_bw for write_stream");
        (void)self;
        (void)s;
    }

    static void write_stream_impl(word_bw_tag<64>, const ReadCmd* self, hls::stream<ap_uint<64>> &s) {
            ap_uint<64> w = 0;
        w = self->tid;
        s.write(w);
        w = 0;
    ...
    template<int word_bw>
    static void write_axi4_stream_impl(word_bw_tag<word_bw>, const ReadCmd* self, hls::stream<streamutils::axi4s_word<word_bw>> &s, bool tlast) {
    ...
    static void write_axi4_stream_impl(word_bw_tag<64>, const ReadCmd* self, hls::stream<streamutils::axi4s_word<64>> &s, bool tlast) {
            ap_uint<64> w = 0;
        w = self->tid;
    ...
    template<int word_bw>
    static void read_array_impl(word_bw_tag<word_bw>, ReadCmd* self, const ap_uint<word_bw> x[]) {
        static_assert(word_bw < 0, "Unsupported word_bw for read_array");
        (void)self;
        (void)x;
    }

    static void read_array_impl(word_bw_tag<64>, ReadCmd* self, const ap_uint<64> x[]) {
        self->tid = (ap_uint<64>)(x[0]);
        self->nsamp = (ap_uint<64>)(x[1]);
        self->raddr = (ap_uint<64>)(x[2]);
    }
    ...
    template<int word_bw>
    static void read_stream_impl(word_bw_tag<word_bw>, ReadCmd* self, hls::stream<ap_uint<word_bw>> &s) {
        static_assert(word_bw < 0, "Unsupported word_bw for read_stream");
        (void)self;
        (void)s;
    }

    static void read_stream_impl(word_bw_tag<64>, ReadCmd* self, hls::stream<ap_uint<64>> &s) {
            ap_uint<64> w = 0;
        w = s.read();
    ...
    template<int word_bw>
    static void read_axi4_stream_impl(word_bw_tag<word_bw>, ReadCmd* self, hls::stream<streamutils::axi4s_word<word_bw>> &s, streamutils::tlast_status &tl) {
    ...
    static void read_axi4_stream_impl(word_bw_tag<64>, ReadCmd* self, hls::stream<streamutils::axi4s_word<64>> &s, streamutils::tlast_status &tl) {
            ap_uint<64> w = 0;
...
#ifdef WAVEFLOW_ENABLE_BRAM_READ_CMD_TB_H_MEMBERS
