#ifndef WAVEFLOW_GEN_RF_RELAYOUT_PORTS_H
#define WAVEFLOW_GEN_RF_RELAYOUT_PORTS_H
// rf_relayout_ports.h -- GENERATED by waveflow (build/composite_gen.py::render_ports_h) from the SAME
// TopSpec that emits rf_relayout's interface pragmas.  DO NOT EDIT: regenerate instead.
// One spec, two consumers -- so a testbench cannot drift from the kernel it drives.

namespace rf_relayout_ports {

static const char* const TOP        = "rf_relayout";
...
#ifdef _WIN32
static const char* const DESIGN_DLL = "xsim.dir/rf_relayout/xsimk.dll";
#else
static const char* const DESIGN_DLL = "xsim.dir/rf_relayout/xsimk.so";
#endif
...
#endif  // WAVEFLOW_GEN_RF_RELAYOUT_PORTS_H
