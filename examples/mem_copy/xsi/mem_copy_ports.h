#ifndef WAVEFLOW_GEN_MEM_COPY_PORTS_H
#define WAVEFLOW_GEN_MEM_COPY_PORTS_H
// mem_copy_ports.h -- GENERATED by waveflow (build/composite_gen.py::render_ports_h) from the SAME
// TopSpec that emits mem_copy's interface pragmas.  DO NOT EDIT: regenerate instead.
// One spec, two consumers -- so a testbench cannot drift from the kernel it drives.

namespace mem_copy_ports {

static const char* const TOP        = "mem_copy";
...
#ifdef _WIN32
static const char* const DESIGN_DLL = "xsim.dir/mem_copy/xsimk.dll";
#else
static const char* const DESIGN_DLL = "xsim.dir/mem_copy/xsimk.so";
#endif
...
#endif  // WAVEFLOW_GEN_MEM_COPY_PORTS_H
