#ifndef INCLUDE_COPY_CMD_H
#define INCLUDE_COPY_CMD_H
...
struct CopyCmd {
    ...
    static ap_uint<bitwidth> pack_to_uint(const CopyCmd& data) {
    ...
    static CopyCmd unpack_from_uint(const ap_uint<bitwidth>& packed) {
        CopyCmd data;
    ...
    template<int word_bw>
    static void write_array_impl(word_bw_tag<word_bw>, const CopyCmd* self, ap_uint<word_bw> x[]) {
        static_assert(word_bw < 0, "Unsupported word_bw for write_array");
        (void)self;
        (void)x;
    }

    static void write_array_impl(word_bw_tag<32>, const CopyCmd* self, ap_uint<32> x[]) {
        x[0] = self->src_off;
        x[1] = self->dst_off;
        x[2] = self->n_words;
        x[3] = self->tx_id;
    ...
    template<int word_bw>
    static void write_stream_impl(word_bw_tag<word_bw>, const CopyCmd* self, hls::stream<ap_uint<word_bw>> &s) {
        static_assert(word_bw < 0, "Unsupported word_bw for write_stream");
        (void)self;
        (void)s;
    }

    static void write_stream_impl(word_bw_tag<32>, const CopyCmd* self, hls::stream<ap_uint<32>> &s) {
            ap_uint<32> w = 0;
        w = self->src_off;
        s.write(w);
        w = 0;
    ...
    static void write_stream_impl(word_bw_tag<64>, const CopyCmd* self, hls::stream<ap_uint<64>> &s) {
            ap_uint<64> w = 0;
        w.range(31, 0) = self->src_off;
        w.range(63, 32) = self->dst_off;
        s.write(w);
        w = 0;
    ...
    template<int word_bw>
    static void write_axi4_stream_impl(word_bw_tag<word_bw>, const CopyCmd* self, hls::stream<streamutils::axi4s_word<word_bw>> &s, bool tlast) {
    ...
    static void write_axi4_stream_impl(word_bw_tag<32>, const CopyCmd* self, hls::stream<streamutils::axi4s_word<32>> &s, bool tlast) {
            ap_uint<32> w = 0;
        w = self->src_off;
    ...
    static void write_axi4_stream_impl(word_bw_tag<64>, const CopyCmd* self, hls::stream<streamutils::axi4s_word<64>> &s, bool tlast) {
            ap_uint<64> w = 0;
        w.range(31, 0) = self->src_off;
        w.range(63, 32) = self->dst_off;
    ...
    template<int word_bw>
    static void read_array_impl(word_bw_tag<word_bw>, CopyCmd* self, const ap_uint<word_bw> x[]) {
        static_assert(word_bw < 0, "Unsupported word_bw for read_array");
        (void)self;
        (void)x;
    }

    static void read_array_impl(word_bw_tag<32>, CopyCmd* self, const ap_uint<32> x[]) {
    ...
    template<int word_bw>
    static void read_stream_impl(word_bw_tag<word_bw>, CopyCmd* self, hls::stream<ap_uint<word_bw>> &s) {
        static_assert(word_bw < 0, "Unsupported word_bw for read_stream");
        (void)self;
        (void)s;
    }

    static void read_stream_impl(word_bw_tag<32>, CopyCmd* self, hls::stream<ap_uint<32>> &s) {
            ap_uint<32> w = 0;
        w = s.read();
        self->src_off = (ap_uint<32>)(w);
        w = s.read();
    ...
    static void read_stream_impl(word_bw_tag<64>, CopyCmd* self, hls::stream<ap_uint<64>> &s) {
            ap_uint<64> w = 0;
        w = s.read();
        self->src_off = (ap_uint<32>)(w.range(31, 0));
    ...
    template<int word_bw>
    static void read_axi4_stream_impl(word_bw_tag<word_bw>, CopyCmd* self, hls::stream<streamutils::axi4s_word<word_bw>> &s, streamutils::tlast_status &tl) {
    ...
    static void read_axi4_stream_impl(word_bw_tag<32>, CopyCmd* self, hls::stream<streamutils::axi4s_word<32>> &s, streamutils::tlast_status &tl) {
            ap_uint<32> w = 0;
    ...
    static void read_axi4_stream_impl(word_bw_tag<64>, CopyCmd* self, hls::stream<streamutils::axi4s_word<64>> &s, streamutils::tlast_status &tl) {
            ap_uint<64> w = 0;
            tl = streamutils::tlast_status::no_tlast;
            bool last = false;
        if (last) {
...
#ifdef WAVEFLOW_ENABLE_COPY_CMD_TB_H_MEMBERS
