#ifndef INCLUDE_COPY_RESP_TB_H
#define INCLUDE_COPY_RESP_TB_H
...
#define WAVEFLOW_ENABLE_COPY_RESP_TB_H_MEMBERS
#include "copy_resp.h"
#undef WAVEFLOW_ENABLE_COPY_RESP_TB_H_MEMBERS

inline void CopyResp::dump_json(std::ostream& os, int indent, int level) const {
...
inline void CopyResp::load_json(const std::string& json_text, size_t& pos) {
...
inline void CopyResp::load_json(std::istream& is) {
...
inline void CopyResp::dump_json_file(const char* file_path, int indent) const {
...
inline void CopyResp::load_json_file(const char* file_path) {
