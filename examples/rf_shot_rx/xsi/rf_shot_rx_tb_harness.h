#ifndef WAVEFLOW_GEN_RF_SHOT_RX_TB_HARNESS_H
#define WAVEFLOW_GEN_RF_SHOT_RX_TB_HARNESS_H
// rf_shot_rx_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
...
#include "rf_shot_rx_ports.h"

namespace rf_shot_rx_tb {
...
struct Harness {
    ...
    explicit Harness(const std::string& wdb)
      : sim(rf_shot_rx_ports::DESIGN_DLL, wdb),
        xsi_tb_adc_if(2),
        samp_in(sim.dut(), rf_shot_rx_ports::samp_in, xsi_tb_adc_if, RfdcFormat{14, 4, 1.0, 16, 2, RFDC_REAL, RFDC_I_LOW}, 0.256),
        w_out(sim.dut(), rf_shot_rx_ports::w_out),
        xsi_tb_adc_if_tx(xsi_tb_adc_if, 64, 0)
    {
        ...
        sim.pin_low(rf_shot_rx_ports::ZERO_PORTS, rf_shot_rx_ports::ZERO_PORTS_N);
...
#endif  // WAVEFLOW_GEN_RF_SHOT_RX_TB_HARNESS_H
