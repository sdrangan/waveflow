// rf_shot_rx_abs_top.v — GENERATED by waveflow (build/wrapper_gen.py::render_wrapper).
// DO NOT EDIT: regenerate instead.
//
// The design scope: the generated kernel `rf_shot_rx_abs` plus the hand-written memories it
