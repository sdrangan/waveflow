// rf_shot_rx_top.v — GENERATED by waveflow (build/wrapper_gen.py::render_wrapper).
// DO NOT EDIT: regenerate instead.
//
// The design scope: the generated kernel `rf_shot_rx` plus the hand-written memories it
