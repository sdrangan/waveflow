#ifndef WAVEFLOW_GEN_RF_SHOT_BUF_TB_HARNESS_H
#define WAVEFLOW_GEN_RF_SHOT_BUF_TB_HARNESS_H
// rf_shot_buf_tb_harness.h -- GENERATED by waveflow (build/composite_gen.py::render_tb_harness)
...
#include <vector>
#include "xsi_bfm.h"
#include "rf_shot_buf_ports.h"

namespace rf_shot_buf_tb {
...
struct Harness {
    ...
    explicit Harness(const std::string& wdb)
      : sim(rf_shot_buf_ports::DESIGN_DLL, wdb),
        s_in(sim.dut(), rf_shot_buf_ports::s_in, {}),
        s_out(sim.dut(), rf_shot_buf_ports::s_out)
    {
        ...
        sim.pin_low(rf_shot_buf_ports::ZERO_PORTS, rf_shot_buf_ports::ZERO_PORTS_N);
...
#endif  // WAVEFLOW_GEN_RF_SHOT_BUF_TB_HARNESS_H
