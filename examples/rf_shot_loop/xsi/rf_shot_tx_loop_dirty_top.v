// rf_shot_tx_loop_dirty_top.v — GENERATED by waveflow (build/wrapper_gen.py::render_wrapper).
// DO NOT EDIT: regenerate instead.
//
// The design scope: the generated kernel `rf_shot_tx_loop_dirty` plus the hand-written memories it
...
`timescale 1ns/1ps
module rf_shot_tx_loop_dirty_top (
    input  ap_clk,
    input  ap_rst_n,
    input  [63:0] s_in_TDATA,
    input  s_in_TVALID,
    output s_in_TREADY,
    input  [7:0] s_in_TKEEP,
    input  [7:0] s_in_TSTRB,
    input  s_in_TLAST,
    output [63:0] resp_out_TDATA,
    output resp_out_TVALID,
    input  resp_out_TREADY,
    output [7:0] resp_out_TKEEP,
    output [7:0] resp_out_TSTRB,
    output resp_out_TLAST,
    output [63:0] samp_out_TDATA,
    output samp_out_TVALID,
    input  samp_out_TREADY
);
    ...
    rf_shot_tx_loop_dirty kernel (
        ...
        .resp_out_TDATA(resp_out_TDATA),
        .resp_out_TVALID(resp_out_TVALID),
        .resp_out_TREADY(resp_out_TREADY),
        .resp_out_TKEEP(resp_out_TKEEP),
        .resp_out_TSTRB(resp_out_TSTRB),
        .resp_out_TLAST(resp_out_TLAST),
        .samp_out_TDATA(samp_out_TDATA),
        .samp_out_TVALID(samp_out_TVALID),
        .samp_out_TREADY(samp_out_TREADY),
