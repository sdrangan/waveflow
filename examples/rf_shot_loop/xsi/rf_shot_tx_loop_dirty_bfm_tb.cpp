// rf_shot_tx_loop_dirty_bfm_tb.cpp -- GENERATED by waveflow (build/composite_gen.py::render_tb_main)
...
int main() {
    rf_shot_tx_loop_dirty_tb::Harness h("rf_shot_tx_loop_dirty_bfm.wdb");
    h.run(1400);
    h.close();
    return 0;
}
